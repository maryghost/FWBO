...
<body style="background-color:#24b3ce;"><div style="background-color:#24b3ce; padding:0px;"><div style="text-align: center;	padding: 30px 0px; #ffffff;"><img src="images/butch-sideviewairplane.png" width="700" height="394" alt=""/>
  <h2 style="font-family: 'Roboto Condensed', sans-serif; 	font-size: 180%; 	font-weight: 700;	color: #ffffff;	text-transform: uppercase;
	text-align: center;">GREAT JOB!    THANKS FOR PLAYING THE AIRPORT MEMORY GAME.</h2>
<h2 style="font-family: 'Roboto Condensed', sans-serif; 	font-size: 160%; 	font-weight: 700;	color: #ffffff;	text-transform: uppercase;
	text-align: center;">Incorrect Guesses: <?php echo $_GET["score"]; ?></h2>
	<h2 style="font-family: 'Roboto Condensed', sans-serif; 	font-size: 160%; 	font-weight: 700;	color: #ffffff;	text-transform: uppercase;
	text-align: center;">Time: <?php echo $_GET["time"]; ?></h2>
...
Exclusions and rules may apply. See an associate for details. Valid only at O’Hare International Airport locations.
  ...
  <p style="font-family: 'Roboto Condensed', sans-serif; 	font-size: 120%; 	font-weight: 700;	color: #ffffff;	text-transform: uppercase;
	text-align: center;"><a href="memory.html"><img src="images/game_flying_play-again_btn.png"></a> <br><br>

<a href="index.html" style="color:#ffffff; text-decoration:none;">Back to all Games  </a> 
