...
function gameStart()
{
	...
	function Stores()
	{
		...
		this.loadImages = function()
		{
			...
			this.storeFiles[0] = PATH_EAT + "EAT_AmericasDog_T1_C17.png";
			this.storeFiles[1] = PATH_EAT + "EAT_ArgoTea_T2_E5.png";
			this.storeFiles[2] = PATH_EAT + "EAT_ArgoTea_T3_H1.png";
			this.storeFiles[3] = PATH_EAT + "EAT_ArgoTea_T3_L2A.png";
			this.storeFiles[4] = PATH_EAT + "EAT_AuntieAnnes_T1_C18.png";
			this.storeFiles[5] = PATH_EAT + "EAT_AuntieAnnes_T2_E4.png";
			this.storeFiles[6] = PATH_EAT + "EAT_Berghoff_T1_C26.png";
			this.storeFiles[7] = PATH_EAT + "EAT_B-Smooth_T3_K4.png";
			this.storeFiles[8] = PATH_EAT + "EAT_BurritoBeach_T3_K4.png";
